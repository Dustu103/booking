...
import { IMovie, IBookingPopulated, DateTimeMap } from '../types'
...
export const dummyTrailers: ITrailer[] = [
    {
...
export const dummyShowsData: IMovie[] = [
    {
        "_id": "324544",
        ...
        "casts": dummyCastsData.map(c => ({ name: c.name, role: 'Actor', image: c.profile_path })),
...
export const dummyBookingData: Partial<IBookingPopulated>[] = [
    {
        "_id": "68396334fb83252d82e17295",
        "user": { name: "GreatStack" } as any,
        "show": {
