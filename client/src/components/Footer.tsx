      ...
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
        <div className="md:max-w-96">
          ...
          <p className="mt-6 text-sm">
            QuickShow is Rwanda's premier movie ticket booking platform, bringing the latest blockbusters directly to your fingertips. Experience seamless booking and atomic seat reservations today.
          </p>
